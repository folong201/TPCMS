...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>Bienvenue a la Mairie de Yaounde IV</h3>
...
<section class="about" id="about">
    ...
    <h1 class="heading"> <span>Presentation de </span> l'arrondissement de Yaounde IV </h1>
...
<section class="footer">
    ...
    <div class="links">
        <a href="#active" id="active">home</a>
        <a href="#">about</a>
        <a href="#">menu</a>
        <a href="#">products</a>
        <a href="#">review</a>
